...
const resources = {
  hr: {
    translation: {
      ...
      "whatsapp_preview_warning": "Savjet: Kada zalijepite ovo u WhatsApp ili Viber, pričekajte nekoliko sekundi da se pojavi pregled aplikacije prije slanja. Poveznica je dugačka jer sadrži sve vaše podatke.",
  ...
  en: {
    translation: {
      ...
      "whatsapp_preview_warning": "Tip: When pasting this into WhatsApp or Viber, wait a few seconds for the app preview to appear before pressing send. The link is long because it contains all your data.",
      "copy_link": "Copy Link",
